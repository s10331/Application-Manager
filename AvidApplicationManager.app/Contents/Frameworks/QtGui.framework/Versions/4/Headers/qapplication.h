...
public:
...
#if defined(Q_WS_MAC)
    virtual bool macEventFilter(CarbonAPI::EventHandlerCallRef, CarbonAPI::EventRef);
#endif
#if defined(Q_WS_X11)
    ...
    static void winMouseButtonUp(Qt::MouseButtons btns, Qt::KeyboardModifiers keys);
#endif
