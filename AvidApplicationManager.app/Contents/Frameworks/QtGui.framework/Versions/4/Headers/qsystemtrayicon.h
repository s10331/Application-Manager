...
public:
    ...
    int showMessage(const QString &title, const QString &msg,
                     MessageIcon iconID = Information, int msecs = 10000);

    int showMessage(const QString &title, const QString &msg,
                     const QIcon& icon, int msecs = 10000);

    void discardMessage(int msgId);
...
private:
    ...
    friend void qtsystray_messageFeedback(QSystemTrayIcon *, int, bool);
};
