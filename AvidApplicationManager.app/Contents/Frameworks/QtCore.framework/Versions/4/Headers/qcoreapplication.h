...
public:
    ...
    static int sendPostedEvents(QObject *receiver, int event_type);
    static int sendPostedEvents();
    static int removePostedEvents(QObject *receiver);
    static int removePostedEvents(QObject *receiver, int eventType);
...
inline int QCoreApplication::sendPostedEvents() { return sendPostedEvents(0, 0); }
